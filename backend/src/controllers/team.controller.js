...
/**
 * Ajouter un membre à l'équipe (créer un utilisateur employé ou stagiaire)
 */
export const addTeamMember = async (req, res) => {
  try {
    ...
    // Vérifier que le rôle est employee ou trainee
    if (role !== 'employee' && role !== 'trainee') {
      return res.status(400).json({ error: 'Le rôle doit être "employee" ou "trainee".' });
    }
